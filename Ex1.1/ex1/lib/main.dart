...
class Car extends Vehicle {
  ...
  void startEngine() {
    if (isElectric) {
      print("Xe điện $brand ($year): Khởi động êm ái, không tiếng động!");
    } else {
      print("Xe xăng $brand ($year): Khởi động động cơ, bụp bụp bụp bụp!");
    }
  }
}
...
void main() {
  ...
  Car normalCar = Car("Toyota", 2024, false);
